...
const Adventure = () => {
    ...
    const fetchMovies = async () => {
      try {
        const res = await fetch(
          "https://api.themoviedb.org/3/discover/movie?api_key=474b1ac1920478cde662af50b6031963&with_genres=12"
        );
  ...
  return (
    <div className="relative w-full bg-black py-10">
      <h1 className="text-[38px] font-extrabold text-white text-center mb-2"> Adventure Movies</h1>
