...
const SciMovie = () => {
    ...
    const fetchMovies = async () => {
      try {
        const res = await fetch(
          "https://api.themoviedb.org/3/discover/movie?api_key=474b1ac1920478cde662af50b6031963&with_genres=878"
        );
  ...
  return (
    <div className="relative w-full bg-black py-10">
      <h1 className="text-[38px] font-extrabold text-white text-center mb-2"> Sci-FI  Movies</h1>
      <h5 className="text-gray-300 text-center mb-8">
        Explore the most Sci-FI movies from TMDB, streaming across the screen.
      </h5>
